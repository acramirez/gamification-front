...
export const environment = {
  production: false,
  tkn:{
    url:'https://mx-gamification-front-mx-gamification-web-dev.appls.mex01.mex.dev.mx1.paas.cloudcenter.corp/api/session',
  ...
  gamification:{
    ...
    url:"https://mx-gamification-front-mx-gamification-web-dev.appls.mex01.mex.dev.mx1.paas.cloudcenter.corp/credits/v2/credits/customer-key/benefits",
